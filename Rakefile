...
task :clean do
  rm_rf "pkg/classes"
  rm_rf "src/main/api_shim/vertx/ext/*.jar"
end

desc "Compile the extension"
task :compile => "pkg/classes" do |t|
  ant.javac :srcdir => "src/main/java", :destdir => t.prerequisites.first,
...
task :jar => [:clean, :compile] do
  ant.jar :basedir => "pkg/classes", :destfile => "src/main/api_shim/vertx/ext/vertx.jar", :includes => "**/*.class"
end
