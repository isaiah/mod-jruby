...
task :compile => "pkg/classes" do |t|
  ant.javac :srcdir => "java", :destdir => t.prerequisites.first,
    ...
    :classpath => "${java.class.path}:${sun.boot.class.path}:jars/jruby.jar:jars/vertx-core-2.1.0-SNAPSHOT.jar:jars/vertx-platform-2.1.0-SNAPSHOT.jar:jars/netty-all-4.0.4.Final.jar"
end
